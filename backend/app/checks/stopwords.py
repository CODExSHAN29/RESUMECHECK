STOPWORDS = frozenset(
    ...
    your yours yourself yourselves will able across along also among around back best better
    bring build come consider ensure etc every getting help including large make must need needed
    new one part please plus provide provides related role team using work working years you'll
    strong including looking join joining team's role's within
    """.split()
)
